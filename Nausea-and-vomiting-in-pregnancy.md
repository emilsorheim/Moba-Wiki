...
[Hyperemesis](Hyperemesis) is not included here.
...
In the code below, variables for [response time](Response-time) for the first questionnaire (Q1) and the third questionnaire (Q3) are used.
